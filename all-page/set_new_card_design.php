    ...
    <?php  //unset($_SESSION['msg2']);}?> -->
       ...
       <div class="row col-md-12 text-light" id="name_input">
            ...
            <div class="mb-2 col-md-12 d-flex">
                ...
                <div class="col-md-8 mx-3">
                    ...
                    <input type="text" class="form-control" id="card_name" name="card_name" aria-describedby="emailHelp" required>
                     <input type="hidden" class="form-control" id="card_type" name="card_type" value="vertical" aria-describedby="emailHelp" required>
                </div>
                <div class="col-md-1 my-3">
                    <button type="submit" name="name_submit" id="name_submit" class="btn btn-primary my-3 mx-1" ><b><i class="fa fa-plus"></i>Create</b></button>
                </div>
                 <div class="col-md-1 my-3">
                    
                    <a href="#" id="save" class="btn btn-success my-3 mx-1"><b><i class="fa fa-arrow-up"></i>Save</b></a>
                </div>
                 <div class="col-md-1 my-3">
                    
                    <a href="set_new_card_horizontal.php?id=<?php echo  $row['id']; ?>" class="btn btn-primary my-3 mx-1 text-light"><b><i class="fa fa-rotate-right"></i>Rotate Card</b></a>
                </div>
                <div class="col-md-1 my-3">
                    
                    <a href="manage_card.php" class="btn btn-secondary my-3 mx-1"><b><i class="fa fa-arrow-left"></i>Back</b></a>
                </div>
        ...
        <div class="row col-md-12 d-flex t" id="board">
                <div class="row col-md-3" id="front">
            ...
            <div class="row col-md-3 t" id="front-set">
                ...
                <div class="row col-md-12 t">
                    <div class="col-md-12 text-light">
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="d-flex col-md-12 tk">
                                ...
                                <div class="col-md-4" style="align-content:center; align-items:center; text-align:center;">
                                 ...
                                 <div class="col-md-4 t border border-3 border-white my-2"  style="align-content:center; align-items:center">
                                   <img src="../asset/image/img/image1.jpg" height="158"  class="img2" style="align-content: center;align-items: center; width: 100%;">
                                </div>
                       ...
                       <hr>
                        <div>
                            <form method="post" action="set_new_card_design_operation.php">
                            <div class="col-md-12 t my-2" style="align-content:center; align-items:center; text-align: center;">
                                <div class="col-md-12 text-center" style="align-content:center; align-items:center; text-align:center;">
            ...
            <div class="row col-md-3" id="back">
            ...
            <div class="row col-md-3" id="back-set">
                  <div class="row col-md-12 t">
                    <div class="col-md-12 text-light t">
                       ...
                       <hr>
                        <div>
                            ...
                            <div class="d-flex tk" style="align-content:center; align-items:center; text-align: center;">
                                <div class="col-md-4" style="align-content:center; align-items:center; text-align:center;">
                                    <form method="post" action="set_new_card_design_operation.php">
                                 ...
                                 <div class="col-md-4 my-2 border border-3 border-white">
                                   <img src="../asset/image/qr-demo.png" class="img2" height="123"  style="align-content: center;align-items: center; margin-left: 1px; width: 100%;">
                                </div>
                                 <div class="col-md-4" style="align-content:center; align-items:center; text-align:center;">
                                    <form method="post" action="set_new_card_design_operation.php">
                           ...
                           <div class="col-md-12 t my-2" style="align-content:center; align-items:center; text-align: center;">
                            ...
                            <div class="d-flex col-md-12 tk" style="align-content:center; align-items:center; text-align: center;">
                                <div class="col-md-3" style="align-content:center; align-items:center; text-align:center;">
                                 ...
                                 <div class="col-md-6 bg-white t bo">
