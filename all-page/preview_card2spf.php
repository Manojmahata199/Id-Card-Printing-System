...
require "../staff_id_generate/vendor/autoload.php";
		            ...
		            <div class="id-1">
		            	...
		            	<!-- to show qr image on the card  -->
		                   ...
		                   <div class="container back">
                                       <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>joining Date</b></span><b>:</b><span class="text3"><b><?php echo $row['joining_date']; ?></span></b>
                                       ...
                                       <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Mobile No</b></span><b>:</b><span class="text3"><b><?php echo $row['mobile']; ?></b></span></p>
                                       <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Emargency No</b></span><b>:</b><span class="text3"><b><?php echo $row['emargency']; ?></b></span></p>
