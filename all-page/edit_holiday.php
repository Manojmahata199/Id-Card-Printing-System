<?php
  ...
  include "../config/conn.php";
   ...
   <div class="container bg-white my-2 rounded-3  shadow-lg bg-body rounded border">
         ...
         <div class="row mt-1">
             <form method="post" action="<?php echo base_link;?>operation/edit_holiday_operation.php" enctype="multipart/form-data">
              ...
              <div>
                ...
                <a href="<?php echo base_link;?>all-page/holiday_list.php" class="btn btn-secondary mx-2">Back</a>
              </div>
