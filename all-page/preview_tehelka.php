		            ...
		            <div id="id">
		                    ...
		                    <div class="d-flex">
		                    	<div class="container text1 text-center name">
			                     	<h4 class=" my-1 mx-1 text-dark"><?php echo $row['name']; ?></h4>
			                     </div>
	                    	...
	                    	<div class="container back">
                                  <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Company Name</b></span><b>:</b><span class="text3"><b><?php echo $row['company_id']; ?></span></b>
	                              ...
	                              <p class="my-1 fs-16 text text-dark d-flex"><span class="text2"><b>Date Of Joining</b></span><b>:</b><span class="text3"><b><?php echo $row['joining_date']; ?></b></span></p>
